...
const links = [
    { id: 1, title: "Lorem ipsum dolor", content: "Lorem ipsum dolor sit amet, consectetur ", image: t4 },
    { id: 2, title: "Lorem ipsum dolor", content: "Lorem ipsum dolor sit amet, consectetur ", image: t2 },
    { id: 3, title: "Lorem ipsum dolor", content: "Lorem ipsum dolor sit amet, consectetur ", image: t3 },
                ...
                <div className="link-slider__wrapper">
                    ...
                    <div className="link-slider__container">
                        {links.slice(startIndex, startIndex + 3).map((link) => (
                            <Paper style={{ width: "25vw", height: "auto", boxShadow: "0px 4px 10px 5px rgba(209, 209, 209, 0.63)" ,margin:"0 0.8vw" }}>
