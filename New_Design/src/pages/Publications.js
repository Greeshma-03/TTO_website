            ...
            <div style={{ height: "auto", paddingTop: "9em" }} >
                ...
                <div style={{ marginTop: "1em" }}>
                    <p style={{ fontFamily: "Montserrat", fontSize: 21, margin: "0em", marginLeft: "2em", textAlign: "left" }}>
                        ...
                        <span style={{ color: '#1F669F' }}> Publications &nbsp;</span>
                    </p>
                </div>
                            ...
                            <Box className={classes.root} style={{boxShadow: '0px 4px 4px rgba(180, 180, 180, 0.25), 4px 0px 4px 4px rgba(158, 155, 155, 0.25)'}}>
                                ...
                                <Box className={classes.filterGroup} style={{ display: 'flex', flexDirection: 'column', margin: '1.5em 0' }} >
                                    <Grid container alignItems="center" spacing={1} justifyContent="space-between">
                                        <Grid item>
                                            <Typography className={classes.heading} variant="subtitle1">Publication Centre</Typography>
                                        </Grid>
                                        <Grid item>
                                            <Search />
                                        </Grid>
...
" />
                                ...
                                <Box className={classes.filterGroup} style={{ display: 'flex', flexDirection: 'column', margin: '1.5em 0' }} >
                                    <Grid container alignItems="center" spacing={1} justifyContent="space-between">
                                        <Grid item>
                                            <Typography className={classes.heading} variant="subtitle1">Author</Typography>
                                        </Grid>
                                        <Grid item>
                                            <Search />
                                        </Grid>
                                ...
                                <Box>
                                    <Box position="relative">
                                        <Box mr={1}>
                                            ...
                                            <TextField
                                                style={{ margin: "1em 0", background: "#FFFFFF",boxShadow: '0px 4px 4px rgba(194, 194, 194, 0.25), 4px 4px 4px rgba(163, 163, 163, 0.25)'
                                            }}
                                                variant="outlined"
                                                size="small"
                        ...
                        <div style={{ flex: "1", margin: "4em 0" ,paddingLeft:"3px"}}>
                            ...
                            <table className="table-auto border" style={{ width: "100%" }}>
                                ...
                                <thead>
                                    <tr style={{ textAlign: "center" }}>
                                        ...
                                        <th className={classNames(classes.heading, 'px-4', 'py-2')} style={{ backgroundColor: '#DCF3FD' }}>Date</th>

                                        <th className={classNames(classes.heading, 'px-4', 'py-2')} style={{ backgroundColor: '#EAF7FC' }} >Authors</th>
                                        <th className={classNames(classes.heading, 'px-4', 'py-2')} style={{ backgroundColor: '#DCF3FD' }}>Report no</th>

                                        <th className={classNames(classes.heading, 'px-4', 'py-2')} style={{ backgroundColor: '#EAF7FC' }} >Full Report</th>
                                    </tr>
                                </thead>
